...
Allowed frame_style values: theme_default, paper_label, soft_scrim, kraft_card, premium_badge, torn_paper, leaf_badge, woven_label, vellum_overlay, brush_stroke, natural_reference_mix.
Allowed font_mood values: theme_default, functional_safe, refined_natural, artisanal_bold.
Allowed contrast_style values: theme_default, light_scrim, balanced_scrim, opaque_card.
Choose frame_style, font_mood, and contrast_style by visual mood only; they are semantic style hints, not coordinates or sizes.
